...
const BENEFITS_DATA = [
  {
    ...
    subtitle: "Em apenas minutos",
    description: "Após a confirmação do pagamento, seu pedido é processado rapidamente. A entrega ocorre em até 5 minutos, para você receber seu produto e aproveitar sem esperar.",
    icon: (
  ...
  },
  {
    id: "security",
    title: "Compra Segura",
    subtitle: "100% transparente e segura",
    description: "Somos reconhecidos no cenário de eFootball pela qualidade e confiança. Trabalhamos com segurança, transparência e responsabilidade para que você possa comprar com tranquilidade.",
    icon: (
      <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description: "Nossa equipe está preparada para oferecer suporte rápido e especializado, ajudando você sempre que precisar e garantindo uma experiência de compra simples e confiável.",
    icon: (
      <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <div className={styles.header}>
        <FadeIn>
          ...
          <p className={styles.subtitle}>
            Oferecemos produtos para gamers com qualidade e preço justo, pensados para melhorar sua gameplay e deixar sua experiência nos jogos ainda melhor.
          </p>
        </FadeIn>
      </div>
